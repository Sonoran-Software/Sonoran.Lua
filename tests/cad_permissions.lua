...
assert(client.cad:replaceAccountPermissionsV2("account-uuid", { "record.4.read", "record.4.edit.selected" }).success)
assert(last_request.body.json.grants[1] == "record.4.read")
assert(last_request.body.json.grants[2] == "record.4.edit.selected")
assert(#last_request.body.json.grants == 2)
